...
// Pattern: value passed as a named property
// in an object literal that is itself an argument to a call.
//
// origin: const projectIds (line 12, column 9)
// hop 2: argument hop — execute('fn', { p_project_ids: projectIds }) call site
...
export async function fetchStats(client: QueryClient) {
  ...
  await client.execute('get_survey_question_stats_batch', {
